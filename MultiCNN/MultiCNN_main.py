...
#save path
header = '/home/leifan/Dropbox/Comb/MultiCNN/'
...
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$   
    ...
    y_train_batch_1 = np.int32(np.zeros(batch_size))
    X_train_batch_01 = np.float32(np.zeros((batch_size,BPTT_length,num_inputs)))
    y_train_batch_01 = np.int32(np.zeros(batch_size))
    ...
    for i in range(num_BPTT_iterations):
        ...
        for k in range(batch_size):
            ...
            y_train_batch_1[k] = y_train_1[batch_k_end_index_1-1]
            ...
            y_train_batch_01[k] = y_train_01[batch_k_end_index_01-1]
           
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
        _, train_accuracy, loss_np = sess.run([model.train, model.accuracy, model.loss],
                feed_dict={model.input_1: X_train_batch_1, model.labels_1: y_train_batch_1,
                            model.input_01: X_train_batch_01, model.labels_01: y_train_batch_01,
                            model.keep_prob_1:train_dropout_1,model.keep_prob_01:train_dropout_01})
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    ...
    train_err[ii] = train_loss_avg
    train_acc[ii] = current_train_acc / np.float(counter)
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
...
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ 
        ...
        loss_np, accuracy_np,actual_out,probs = sess.run([model.loss, model.accuracy, model.labels_01, model.u_prob],
...
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
        ...
        current_test_error += loss_np
        current_test_acc += accuracy_np
        counter += 1
    ...
    accuracy_np_ave = current_test_acc / np.float32(counter)
    loss_np_ave = current_test_error / np.float32(counter)
    test_acc[ii] = accuracy_np_ave
    test_err[ii] = loss_np_ave
    cond_acc[ii] = conditional_accuracy
    eval_error_tracker.append((accuracy_np_ave, loss_np_ave, conditional_accuracy))
    print(stock_ticker, 'train_err', train_err[ii],  'test_err', test_err[ii], 'train_acc', train_acc[ii], 'test_acc', test_acc[ii], 'conditional_acc', cond_acc[ii])
    if (ii+1)%10 == 0:
