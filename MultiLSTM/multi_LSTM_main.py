...
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$   
    ...
    counter = 0
    state_1 = sess.run(model.reset_state_1)
...
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
        ...
        state_01 = sess.run(model.reset_state_01)
        cost_train, acc_train,_,state_1,_ = sess.run([model.cost,model.accuracy, model.train_op,model.next_state_1,model.next_state_01],
                feed_dict = {model.input_1: X_train_batch_1,model.labels_1: y_train_batch_1,
                            ...
                            model.state_1:state_1, model.state_01:state_01})
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
        random_start_time_index = random_start_time_index + BPTT_length
        counter += 1
        current_train_error += cost_train
        current_train_acc += acc_train

    train_err[ii] = current_train_error/np.float(counter)
    train_acc[ii] = current_train_acc /np.float(counter)
    train_error_tracker.append(train_err[ii])
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
...
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
        ...
        counter += 1
        current_test_error += cost_test
        current_test_acc += acc_test
    ...
    test_err[ii] = current_test_error/np.float(counter)
    test_acc[ii] = current_test_acc /np.float(counter)
    cond_acc[ii] = conditional_acc
    if (ii+1)%10==0:
        saver.save(sess, path_saver)

train_err = pd.DataFrame(train_err)
train_err.to_csv(file_path+'train_err.csv')
train_acc = pd.DataFrame(train_acc)
train_acc.to_csv(file_path+'train_acc.csv')
test_err = pd.DataFrame(test_err)
test_err.to_csv(file_path+'test_err.csv')
test_acc = pd.DataFrame(test_acc)
test_acc.to_csv(file_path+'test_acc.csv')
